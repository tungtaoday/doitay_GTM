# Doitay - Hồ Sơ Thợ — Hồ sơ SUBMIT LẠI Zalo Mini App (vòng 2)
...
- ⚠️ Console → Thông tin ứng dụng → đổi **Tên ứng dụng = `Doitay - Hồ Sơ Thợ`** cho khớp code.
...
3 ☐ Console: đổi Tên ứng dụng = "Doitay - Hồ Sơ Thợ"
...
**Mô tả phiên bản:**
```
Đổi tên ứng dụng thành Doitay - Hồ Sơ Thợ gắn với thương hiệu Doitay của chủ sở hữu, theo góp ý của bộ phận kiểm duyệt. Đã cập nhật loại hình sở hữu Hộ Kinh doanh và danh mục Tiện ích đời sống, Sửa chữa bảo hành. Ứng dụng không có đăng nhập hay tài khoản riêng, người dùng mở là tạo hồ sơ ngay, danh tính do Zalo cung cấp.
```
...
---
## GHI CHÚ
- Chính sách bảo mật doitay.vn/bao-mat đã đề cập app + thu thập SĐT (vòng 1) — nếu đổi tên chính thức, nên sửa câu "Zalo Mini App \"Thợ Tốt Doitay\"" thành "Doitay - Hồ Sơ Thợ" cho khớp.
